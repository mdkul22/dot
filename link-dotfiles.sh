...
link_dotfile "$dotfiles_dir/task_hooks/on-modify.timewarrior" "$HOME/.task/hooks/on-modify.timewarrior"
link_dotfile "$dotfiles_dir/task_hooks/on-modify-update.py" "$HOME/.task/hooks/on-modify-update.py"
